...
(
    ...
    `show` INT COMMENT 'show returns the number of times impressions has been shown',
...
CREATE UNIQUE INDEX sup_src_id_uindex ON sup_src (id);
CREATE UNIQUE INDEX sup_src_index_gp ON sup_dem_src (supplier,time_id)
