...
func getRawPub(in entity.Publisher) rawPub {
	return rawPub{
		Name:         in.Name(),
...
func getRawLocation(in entity.Location) rawLocation {
	return rawLocation{
		LatLon:   in.LatLon(),
...
func getRawSlots(in []entity.Slot) []rawSlot {
...
func getRawImpresssion(imp entity.Impression) interface{} {
	checkIP := func() string {
		if i := imp.IP(); i != nil {
			return i.String()
		}
