...
func (a *Advertise) Demand() entity.Demand { return a.demand }
...
func (i *Impression) Source() entity.Publisher           { return i.publisher }
func (i *Impression) Location() entity.Location          { panic("Impression") }
func (i *Impression) Attributes() map[string]interface{} { panic("Impression") }
func (i *Impression) Slots() []entity.Slot               { panic("Impression") }
func (i *Impression) Category() []entity.Category        { panic("Impression") }
func (i *Impression) Type() entity.ImpressionType        { panic("Impression") }
...
func (d *Demand) Provide(context.Context, entity.Impression, chan map[string]entity.Advertise) {
	panic("Demand")
}
...
func (p *Publisher) Supplier() entity.Supplier          { panic("publisher") }
...
func TestSelect(t *testing.T) {
	...
	for _, u := range cases() {
		Convey("SelectCPM function test with case number "+strconv.Itoa(u.Case), t, func() {
			...
			slots := make(map[string][]entity.Advertise)
			id := <-random.ID
			slots[id] = ads
	...
	Convey("SelectCPM function Should return nil", t, func() {
		m := &Impression{}
		id := <-random.ID
		s := make(map[string][]entity.Advertise)
		s[id] = nil
		r := SelectCPM(m, s)
		So(r[id], ShouldBeNil)
	})
