...
--
-- Table structure for table `impressions20190206`
--

DROP TABLE IF EXISTS `impressions20190206`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `impressions20190206` (
  `imp_id` int(11) NOT NULL AUTO_INCREMENT,
  `reserved_hash` varchar(63) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_id` int(11) DEFAULT '0',
  `w_id` int(11) DEFAULT '0',
  `app_id` int(11) DEFAULT '0',
  `wp_id` int(11) DEFAULT '0',
  ...
  `imp_ipaddress` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `imp_referaddress` text COLLATE utf8mb4_unicode_ci,
  `imp_parenturl` text COLLATE utf8mb4_unicode_ci,
  `imp_url` text COLLATE utf8mb4_unicode_ci,
  `imp_winnerbid` int(11) DEFAULT '0',
  `imp_status` tinyint(1) DEFAULT '0',
  `imp_cookie` tinyint(1) DEFAULT '1',
  `imp_alexa` tinyint(1) DEFAULT '0',
  ...
  `s_name` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'clickyab',
...
) ENGINE=InnoDB AUTO_INCREMENT=1624797324 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `impressions20190207`
--

DROP TABLE IF EXISTS `impressions20190207`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `impressions20190207` (
  `imp_id` int(11) NOT NULL AUTO_INCREMENT,
  `reserved_hash` varchar(63) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_id` int(11) DEFAULT '0',
  `w_id` int(11) DEFAULT '0',
  ...
  KEY `app_adsize` (`ad_size`,`app_id`),
  KEY `reserved_hash` (`reserved_hash`)
) ENGINE=InnoDB AUTO_INCREMENT=1811224989 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `impressions20190208`
--

DROP TABLE IF EXISTS `impressions20190208`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `impressions20190208` (
  `imp_id` int(11) NOT NULL AUTO_INCREMENT,
  `reserved_hash` varchar(63) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cp_id` int(11) DEFAULT '0',
  `w_id` int(11) DEFAULT '0',
  ...
  KEY `app_adsize` (`ad_size`,`app_id`),
  KEY `reserved_hash` (`reserved_hash`)
) ENGINE=InnoDB AUTO_INCREMENT=400000001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
