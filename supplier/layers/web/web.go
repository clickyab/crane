...
.tiny {height: 18px;width: 19px;position: absolute;top: 0px;right: 0;z-index: 100;background: url(//static.clickyab.com/img/clickyab-tiny.png) right top no-repeat;border-bottom-left-radius: 4px;-moz-border-radius-bottomleft: 4px;} .cyb-bholder img {max-width:{{ .W }}px;margin:auto}
