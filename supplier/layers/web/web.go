...
func init() {
	templ = template.Must(template.New("banner").Parse(`<div class="cyb-bholder" style="position:relative;max-width:{{ .W }}px;overflow:hidden;" ><style>
...
</style><a class="tiny" href="https://www.clickyab.com" target="_blank"></a>{{ .Markup }}{{ if .ShowT }} <iframe src="//t.clickyab.com" frameborder="0" height="1" width="1" style="position: absolute; top: -10000px; left: -10000px"></iframe>{{ end }}</div>`))
