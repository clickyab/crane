import {corners, fontFamilies, fontSizes, INative, INativeOptions, position} from "./definitions/native";
...
export default class NativeComponent {
	...
	private addWrapperStyle() {
		...
		if (width < 420) {
			this.addClass("xs");
		} else if (420 <= width && width < 720) {
			this.addClass("sm");
		} else if (720 <= width && width < 992) {
			this.addClass("md");
	...
	private loadNativeJson(): Promise<INative> {
		console.log(Object.assign(this.defaultOptions, this.customOptions));
			...
			<div class="title-holder">
				...
				<div class="logo">
					<a rel="nofollow" target="_blank" href="https://www.clickyab.com/?ref=icon" class="cyb-logo-container">
						پیشنهاد شده توسط کلیک&zwnj;یاب
