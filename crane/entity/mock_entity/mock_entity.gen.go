...
// Source: clickyab.com/crane/crane/entity (interfaces: Impression,Advertise,Campaign,Publisher,QPublisher,Location,Slot,Supplier,Request,ClickProvider)
...
func (_mr *MockQPublisherMockRecorder) ByPlatform(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ByPlatform", arg0, arg1, arg2)
}
...
// MockClickProvider is a mock of ClickProvider interface
type MockClickProvider struct {
	ctrl     *gomock.Controller
	recorder *MockClickProviderMockRecorder
}

// MockClickProviderMockRecorder is the mock recorder for MockClickProvider
type MockClickProviderMockRecorder struct {
	mock *MockClickProvider
}

// NewMockClickProvider creates a new mock instance
func NewMockClickProvider(ctrl *gomock.Controller) *MockClickProvider {
	mock := &MockClickProvider{ctrl: ctrl}
	mock.recorder = &MockClickProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (_m *MockClickProvider) EXPECT() *MockClickProviderMockRecorder {
	return _m.recorder
}

// ClickURL mocks base method
func (_m *MockClickProvider) ClickURL(_param0 entity.Slot, _param1 entity.Impression) string {
	ret := _m.ctrl.Call(_m, "ClickURL", _param0, _param1)
	ret0, _ := ret[0].(string)
	return ret0
}

// ClickURL indicates an expected call of ClickURL
func (_mr *MockClickProviderMockRecorder) ClickURL(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ClickURL", arg0, arg1)
}
