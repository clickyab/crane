...
import (
	...
	"rubickad.com/clickyab-cyrest/src/modules/telegram/ad/ads"
)
...
type Publisher struct {
	...
	Platform      entity.Platforms `json:"platform" db:"platform"`
	FActive       ads.ActiveStatus `json:"active" db:"active"`
