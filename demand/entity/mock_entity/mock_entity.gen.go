...
// Source: clickyab.com/crane/demand/entity (interfaces: Context,Creative,Campaign,Publisher,Location,Seat,Supplier,Request,User)
...
func (m *MockContext) SoftFloorCPM() int64 {
...
func (mr *MockContextMockRecorder) SubType() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubType", reflect.TypeOf((*MockContext)(nil).SubType))
}
...
// SubType mocks base method
func (m *MockSeat) SubType() entity.RequestType {
	ret := m.ctrl.Call(m, "SubType")
	ret0, _ := ret[0].(entity.RequestType)
	return ret0
}
...
// SubType indicates an expected call of SubType
func (mr *MockSeatMockRecorder) SubType() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubType", reflect.TypeOf((*MockSeat)(nil).SubType))
}
...
// Type mocks base method
func (m *MockSeat) Type() entity.RequestType {
	ret := m.ctrl.Call(m, "Type")
	ret0, _ := ret[0].(entity.RequestType)
	return ret0
}
...
func (m *MockSupplier) UnderFloor() bool {
...
func (mr *MockSupplierMockRecorder) UnderFloor() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnderFloor", reflect.TypeOf((*MockSupplier)(nil).UnderFloor))
}
